  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 a9 03 00 00       	call   3e5 <open>
  ...
  57:	e8 71 03 00 00       	call   3cd <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 3c 03 00 00       	call   3a5 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 88 04 00 00       	call   500 <printf>
      exit();
  78:	e8 28 03 00 00       	call   3a5 <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 19 03 00 00       	call   3a5 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 15 03 00 00       	call   3c5 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 f3 02 00 00       	call   3bd <read>
  ...
  e7:	e8 14 04 00 00       	call   500 <printf>
      exit();
  ec:	e8 b4 02 00 00       	call   3a5 <exit>
  ...
  fa:	e8 01 04 00 00       	call   500 <printf>
    exit();
  ff:	e8 a1 02 00 00       	call   3a5 <exit>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 75 01 00 00       	call   3bd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 33 01 00 00       	call   3e5 <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 36 01 00 00       	call   3fd <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 fc 00 00 00       	call   3cd <close>
  return r;
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 4d0:	e8 f0 fe ff ff       	call   3c5 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 540:	e8 80 fe ff ff       	call   3c5 <write>
 ...
 5a1:	e8 1f fe ff ff       	call   3c5 <write>
 ...
 5b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 5ba:	e8 06 fe ff ff       	call   3c5 <write>
  for(i = 0; fmt[i]; i++){
 ...
 653:	57                   	push   %edi
 654:	53                   	push   %ebx
 655:	e8 6b fd ff ff       	call   3c5 <write>
        while(*s != 0){
 ...
 6a7:	e8 19 fd ff ff       	call   3c5 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7be:	56                   	push   %esi
 7bf:	e8 69 fc ff ff       	call   42d <sbrk>
  if(p == (char*)-1)
