...
main(int argc, char *argv[])
{
  ...
  exit();
  5c:	e8 a4 02 00 00       	call   305 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
 ...
 188:	89 f3                	mov    %esi,%ebx
{
 ...
 1a0:	50                   	push   %eax
 1a1:	6a 00                	push   $0x0
 1a3:	e8 75 01 00 00       	call   31d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 33 01 00 00       	call   345 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 36 01 00 00       	call   35d <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 fc 00 00 00       	call   32d <close>
  return r;
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 430:	e8 f0 fe ff ff       	call   325 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a0:	e8 80 fe ff ff       	call   325 <write>
 ...
 501:	e8 1f fe ff ff       	call   325 <write>
 ...
 518:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 51a:	e8 06 fe ff ff       	call   325 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b3:	57                   	push   %edi
 5b4:	53                   	push   %ebx
 5b5:	e8 6b fd ff ff       	call   325 <write>
        while(*s != 0){
 ...
 607:	e8 19 fd ff ff       	call   325 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 71e:	56                   	push   %esi
 71f:	e8 69 fc ff ff       	call   38d <sbrk>
  if(p == (char*)-1)
