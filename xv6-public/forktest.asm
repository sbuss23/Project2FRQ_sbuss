...
main(void)
{
  ...
  exit();
  16:	e8 ca 03 00 00       	call   3e5 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
00000020 <printf>:
{
  ...
  38:	e8 c8 03 00 00       	call   405 <write>
}
  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  59:	68 98 04 00 00       	push   $0x498
  5e:	e8 6d 01 00 00       	call   1d0 <strlen>
  63:	83 c4 0c             	add    $0xc,%esp
  66:	50                   	push   %eax
  67:	68 98 04 00 00       	push   $0x498
  6c:	6a 01                	push   $0x1
  6e:	e8 92 03 00 00       	call   405 <write>
  ...
  8f:	74 4f                	je     e0 <forktest+0x90>
    pid = fork();
  91:	e8 47 03 00 00       	call   3dd <fork>
    if(pid < 0)
  ...
  9e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  a0:	e8 48 03 00 00       	call   3ed <wait>
  ...
  e3:	68 d8 04 00 00       	push   $0x4d8
  e8:	e8 e3 00 00 00       	call   1d0 <strlen>
  ed:	83 c4 0c             	add    $0xc,%esp
  f0:	50                   	push   %eax
  f1:	68 d8 04 00 00       	push   $0x4d8
  f6:	6a 01                	push   $0x1
  f8:	e8 08 03 00 00       	call   405 <write>
    exit();
  fd:	e8 e3 02 00 00       	call   3e5 <exit>
      exit();
 102:	e8 de 02 00 00       	call   3e5 <exit>
  write(fd, s, strlen(s));
 107:	83 ec 0c             	sub    $0xc,%esp
 10a:	68 a3 04 00 00       	push   $0x4a3
 10f:	e8 bc 00 00 00       	call   1d0 <strlen>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	50                   	push   %eax
 118:	68 a3 04 00 00       	push   $0x4a3
 11d:	6a 01                	push   $0x1
 11f:	e8 e1 02 00 00       	call   405 <write>
      exit();
 124:	e8 bc 02 00 00       	call   3e5 <exit>
  write(fd, s, strlen(s));
 129:	83 ec 0c             	sub    $0xc,%esp
 12c:	68 b7 04 00 00       	push   $0x4b7
 131:	e8 9a 00 00 00       	call   1d0 <strlen>
 136:	83 c4 0c             	add    $0xc,%esp
 139:	50                   	push   %eax
 13a:	68 b7 04 00 00       	push   $0x4b7
 13f:	6a 01                	push   $0x1
 141:	e8 bf 02 00 00       	call   405 <write>
    exit();
 146:	e8 9a 02 00 00       	call   3e5 <exit>
 ...
 268:	89 f3                	mov    %esi,%ebx
{
 ...
 280:	50                   	push   %eax
 281:	6a 00                	push   $0x0
 283:	e8 75 01 00 00       	call   3fd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ed:	e8 33 01 00 00       	call   425 <open>
  if(fd < 0)
 ...
 301:	50                   	push   %eax
 302:	e8 36 01 00 00       	call   43d <fstat>
  close(fd);
 307:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 30a:	89 c6                	mov    %eax,%esi
  close(fd);
 30c:	e8 fc 00 00 00       	call   40d <close>
  return r;
