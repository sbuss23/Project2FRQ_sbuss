...
main(int argc, char *argv[])
{
  ...
  3b:	6a 00                	push   $0x0
  3d:	ff 33                	pushl  (%ebx)
  3f:	e8 c1 05 00 00       	call   605 <open>
  ...
  66:	e8 82 05 00 00       	call   5ed <close>
  for(i = 2; i < argc; i++){
  ...
  exit();
  72:	e8 4e 05 00 00       	call   5c5 <exit>
    grep(pattern, 0);
  77:	52                   	push   %edx
  78:	52                   	push   %edx
  79:	6a 00                	push   $0x0
  ...
  7c:	e8 af 01 00 00       	call   230 <grep>
    exit();
  81:	e8 3f 05 00 00       	call   5c5 <exit>
      printf(1, "grep: cannot open %s\n", argv[i]);
  86:	50                   	push   %eax
  87:	ff 33                	pushl  (%ebx)
  ...
  90:	e8 8b 06 00 00       	call   720 <printf>
      exit();
  95:	e8 2b 05 00 00       	call   5c5 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  9a:	51                   	push   %ecx
  9b:	51                   	push   %ecx
  ...
  a3:	e8 78 06 00 00       	call   720 <printf>
    exit();
  a8:	e8 18 05 00 00       	call   5c5 <exit>
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 255:	e8 83 03 00 00       	call   5dd <read>
 ...
 2c4:	89 fb                	mov    %edi,%ebx
        write(1, p, q+1 - p);
 2c6:	6a 01                	push   $0x1
 2c8:	e8 18 03 00 00       	call   5e5 <write>
 ...
 448:	89 f3                	mov    %esi,%ebx
{
 ...
 460:	50                   	push   %eax
 461:	6a 00                	push   $0x0
 463:	e8 75 01 00 00       	call   5dd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4cd:	e8 33 01 00 00       	call   605 <open>
  if(fd < 0)
 ...
 4e1:	50                   	push   %eax
 4e2:	e8 36 01 00 00       	call   61d <fstat>
  close(fd);
 4e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4ea:	89 c6                	mov    %eax,%esi
  close(fd);
 4ec:	e8 fc 00 00 00       	call   5ed <close>
  return r;
 ...
 689:	85 d2                	test   %edx,%edx
{
 ...
 6f0:	e8 f0 fe ff ff       	call   5e5 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 760:	e8 80 fe ff ff       	call   5e5 <write>
 ...
 7c1:	e8 1f fe ff ff       	call   5e5 <write>
 ...
 7d8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 7da:	e8 06 fe ff ff       	call   5e5 <write>
  for(i = 0; fmt[i]; i++){
 ...
 873:	57                   	push   %edi
 874:	53                   	push   %ebx
 875:	e8 6b fd ff ff       	call   5e5 <write>
        while(*s != 0){
 ...
 8c7:	e8 19 fd ff ff       	call   5e5 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9de:	56                   	push   %esi
 9df:	e8 69 fc ff ff       	call   64d <sbrk>
  if(p == (char*)-1)
