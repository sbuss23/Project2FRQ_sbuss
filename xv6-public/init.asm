...
main(void)
{
  ...
  19:	e8 a7 03 00 00       	call   3c5 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 ca 03 00 00       	call   3fd <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 be 03 00 00       	call   3fd <dup>
  ...
  52:	e8 89 04 00 00       	call   4e0 <printf>
    pid = fork();
  57:	e8 21 03 00 00       	call   37d <fork>
    if(pid < 0){
  ...
  70:	e8 18 03 00 00       	call   38d <wait>
  ...
  9a:	e8 41 04 00 00       	call   4e0 <printf>
      exit();
  9f:	e8 e1 02 00 00       	call   385 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 98 0b 00 00       	push   $0xb98
  ab:	68 66 08 00 00       	push   $0x866
  b0:	e8 08 03 00 00       	call   3bd <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 1d 04 00 00       	call   4e0 <printf>
      exit();
  c3:	e8 bd 02 00 00       	call   385 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 38 08 00 00       	push   $0x838
  d2:	e8 f6 02 00 00       	call   3cd <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 38 08 00 00       	push   $0x838
  e0:	e8 e0 02 00 00       	call   3c5 <open>
 ...
 208:	89 f3                	mov    %esi,%ebx
{
 ...
 220:	50                   	push   %eax
 221:	6a 00                	push   $0x0
 223:	e8 75 01 00 00       	call   39d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 28d:	e8 33 01 00 00       	call   3c5 <open>
  if(fd < 0)
 ...
 2a1:	50                   	push   %eax
 2a2:	e8 36 01 00 00       	call   3dd <fstat>
  close(fd);
 2a7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2aa:	89 c6                	mov    %eax,%esi
  close(fd);
 2ac:	e8 fc 00 00 00       	call   3ad <close>
  return r;
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 4b0:	e8 f0 fe ff ff       	call   3a5 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 520:	e8 80 fe ff ff       	call   3a5 <write>
 ...
 581:	e8 1f fe ff ff       	call   3a5 <write>
 ...
 633:	57                   	push   %edi
 634:	53                   	push   %ebx
 635:	e8 6b fd ff ff       	call   3a5 <write>
        while(*s != 0){
 ...
 687:	e8 19 fd ff ff       	call   3a5 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 79e:	56                   	push   %esi
 79f:	e8 69 fc ff ff       	call   40d <sbrk>
  if(p == (char*)-1)
