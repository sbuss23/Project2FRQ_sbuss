   ...
   7:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 2b 04 00 00       	call   450 <printf>
    exit();
  25:	e8 cb 02 00 00       	call   2f5 <exit>
  }
  ...
  32:	e8 1e 03 00 00       	call   355 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 b2 02 00 00       	call   2f5 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 178:	89 f3                	mov    %esi,%ebx
{
 ...
 190:	50                   	push   %eax
 191:	6a 00                	push   $0x0
 193:	e8 75 01 00 00       	call   30d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 33 01 00 00       	call   335 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 36 01 00 00       	call   34d <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 fc 00 00 00       	call   31d <close>
  return r;
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 420:	e8 f0 fe ff ff       	call   315 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 490:	e8 80 fe ff ff       	call   315 <write>
 ...
 4f1:	e8 1f fe ff ff       	call   315 <write>
 ...
 508:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 50a:	e8 06 fe ff ff       	call   315 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 6b fd ff ff       	call   315 <write>
        while(*s != 0){
 ...
 5f7:	e8 19 fd ff ff       	call   315 <write>
        ap++;
 ...
 621:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 e0 0a 00 00       	mov    %eax,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 777:	0a 00 00 
 77a:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 e4 0a 00 00       	mov    $0xae4,%eax
