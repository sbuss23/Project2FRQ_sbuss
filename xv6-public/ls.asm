...
main(int argc, char *argv[])
{
  ...
  exit();
  3c:	e8 84 05 00 00       	call   5c5 <exit>
    ls(".");
  41:	83 ec 0c             	sub    $0xc,%esp
  44:	68 c0 0a 00 00       	push   $0xac0
  49:	e8 b2 00 00 00       	call   100 <ls>
    exit();
  4e:	e8 72 05 00 00       	call   5c5 <exit>
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 ee 04 00 00       	call   605 <open>
 ...
 129:	56                   	push   %esi
 12a:	50                   	push   %eax
 12b:	e8 ed 04 00 00       	call   61d <fstat>
 ...
 155:	53                   	push   %ebx
 156:	e8 92 04 00 00       	call   5ed <close>
 ...
 213:	e8 d5 03 00 00       	call   5ed <close>
    return;
 ...
 26b:	50                   	push   %eax
 26c:	53                   	push   %ebx
 26d:	e8 6b 03 00 00       	call   5dd <read>
