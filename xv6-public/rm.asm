...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 2b 03 00 00       	call   365 <unlink>
  ...
  exit();
  4b:	e8 c5 02 00 00       	call   315 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 fe 03 00 00       	call   470 <printf>
    exit();
  72:	e8 9e 02 00 00       	call   315 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 75 01 00 00       	call   32d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 33 01 00 00       	call   355 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 36 01 00 00       	call   36d <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 fc 00 00 00       	call   33d <close>
  return r;
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 440:	e8 f0 fe ff ff       	call   335 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4b0:	e8 80 fe ff ff       	call   335 <write>
 ...
 511:	e8 1f fe ff ff       	call   335 <write>
 ...
 528:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 52a:	e8 06 fe ff ff       	call   335 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5c3:	57                   	push   %edi
 5c4:	53                   	push   %ebx
 5c5:	e8 6b fd ff ff       	call   335 <write>
        while(*s != 0){
 ...
 617:	e8 19 fd ff ff       	call   335 <write>
        ap++;
 ...
 641:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 0c 0b 00 00    	cmp    %eax,0xb0c
 727:	89 c2                	mov    %eax,%edx
 729:	75 ed                	jne    718 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 72b:	83 ec 0c             	sub    $0xc,%esp
 72e:	56                   	push   %esi
 72f:	e8 69 fc ff ff       	call   39d <sbrk>
  if(p == (char*)-1)
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 797:	0b 00 00 
 79a:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 7a1:	0b 00 00 
    base.s.size = 0;
 7a4:	b8 10 0b 00 00       	mov    $0xb10,%eax
