...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      27:	e8 69 0d 00 00       	call   d95 <open>
...
fork1(void)
{
  ...
  pid = fork();
      41:	e8 07 0d 00 00       	call   d4d <fork>
  if(pid == -1)
    ...
    wait();
      4f:	e8 09 0d 00 00       	call   d5d <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
  ...
  pid = fork();
      7c:	e8 cc 0c 00 00       	call   d4d <fork>
  if(pid == -1)
    ...
    panic("fork");
      ...
      96:	50                   	push   %eax
      97:	e8 e1 0c 00 00       	call   d7d <close>
      break;
      9c:	83 c4 10             	add    $0x10,%esp
      9f:	eb b3                	jmp    54 <main+0x54>
  exit();
      a1:	e8 af 0c 00 00       	call   d55 <exit>
      runcmd(parsecmd(buf));
      ...
      if(chdir(buf+3) < 0)
      d6:	e8 ea 0c 00 00       	call   dc5 <chdir>
...
00000150 <panic>:
{
  ...
  exit();
     165:	e8 eb 0b 00 00       	call   d55 <exit>
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     19c:	52                   	push   %edx
     19d:	50                   	push   %eax
     19e:	e8 ea 0b 00 00       	call   d8d <exec>
    ...
    exit();
     1b8:	e8 98 0b 00 00       	call   d55 <exit>
  pid = fork();
     1bd:	e8 8b 0b 00 00       	call   d4d <fork>
  if(pid == -1)
    ...
    close(rcmd->fd);
     ...
     1e0:	e8 98 0b 00 00       	call   d7d <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     1e5:	59                   	pop    %ecx
     1e6:	58                   	pop    %eax
     1e7:	ff 73 10             	pushl  0x10(%ebx)
     1ea:	ff 73 08             	pushl  0x8(%ebx)
     1ed:	e8 a3 0b 00 00       	call   d95 <open>
  ...
  pid = fork();
     237:	e8 11 0b 00 00       	call   d4d <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     24b:	e8 2d 0b 00 00       	call   d7d <close>
    close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 24 0b 00 00       	call   d7d <close>
    wait();
     259:	e8 ff 0a 00 00       	call   d5d <wait>
    wait();
     25e:	e8 fa 0a 00 00       	call   d5d <wait>
    break;
     263:	83 c4 10             	add    $0x10,%esp
     266:	e9 4d ff ff ff       	jmp    1b8 <runcmd+0x48>
  pid = fork();
     26b:	e8 dd 0a 00 00       	call   d4d <fork>
  if(pid == -1)
    ...
    wait();
     27d:	e8 db 0a 00 00       	call   d5d <wait>
    runcmd(lcmd->right);
    ...
    panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 cc 0a 00 00       	call   d7d <close>
      dup(p[0]);
     2b1:	5a                   	pop    %edx
     2b2:	ff 75 f0             	pushl  -0x10(%ebp)
     2b5:	e8 13 0b 00 00       	call   dcd <dup>
      close(p[0]);
     2ba:	59                   	pop    %ecx
     2bb:	ff 75 f0             	pushl  -0x10(%ebp)
     2be:	e8 ba 0a 00 00       	call   d7d <close>
      close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 b1 0a 00 00       	call   d7d <close>
      runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 91 0a 00 00       	call   d7d <close>
      dup(p[1]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f4             	pushl  -0xc(%ebp)
     2f0:	e8 d8 0a 00 00       	call   dcd <dup>
      close(p[0]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f0             	pushl  -0x10(%ebp)
     2f9:	e8 7f 0a 00 00       	call   d7d <close>
      close(p[1]);
     2fe:	58                   	pop    %eax
     2ff:	ff 75 f4             	pushl  -0xc(%ebp)
     302:	e8 76 0a 00 00       	call   d7d <close>
      runcmd(pcmd->left);
     307:	58                   	pop    %eax
...
00000310 <fork1>:
{
  ...
  pid = fork();
     316:	e8 32 0a 00 00       	call   d4d <fork>
  if(pid == -1)
     ...
     bd8:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     bf0:	50                   	push   %eax
     bf1:	6a 00                	push   $0x0
     bf3:	e8 75 01 00 00       	call   d6d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     c5d:	e8 33 01 00 00       	call   d95 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     c71:	50                   	push   %eax
     c72:	e8 36 01 00 00       	call   dad <fstat>
  close(fd);
     c77:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     c7a:	89 c6                	mov    %eax,%esi
  close(fd);
     c7c:	e8 fc 00 00 00       	call   d7d <close>
  return r;
...
void unlock(struct spinlock * lk) { 
     ...
     d45:	8b 55 08             	mov    0x8(%ebp),%edx
     d48:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
}
     d4b:	5d                   	pop    %ebp
     d4c:	c3                   	ret    
...
00000d55 <exit>:
SYSCALL(exit)
     d55:	b8 02 00 00 00       	mov    $0x2,%eax
     d5a:	cd 40                	int    $0x40
     d5c:	c3                   	ret    

00000d5d <wait>:
SYSCALL(wait)
     d5d:	b8 03 00 00 00       	mov    $0x3,%eax
     d62:	cd 40                	int    $0x40
     d64:	c3                   	ret    

00000d65 <pipe>:
SYSCALL(pipe)
     d65:	b8 04 00 00 00       	mov    $0x4,%eax
     d6a:	cd 40                	int    $0x40
     d6c:	c3                   	ret    

00000d6d <read>:
SYSCALL(read)
     d6d:	b8 05 00 00 00       	mov    $0x5,%eax
     d72:	cd 40                	int    $0x40
     d74:	c3                   	ret    

00000d75 <write>:
SYSCALL(write)
     d75:	b8 10 00 00 00       	mov    $0x10,%eax
     d7a:	cd 40                	int    $0x40
     d7c:	c3                   	ret    

00000d7d <close>:
SYSCALL(close)
     d7d:	b8 15 00 00 00       	mov    $0x15,%eax
     d82:	cd 40                	int    $0x40
     d84:	c3                   	ret    

00000d85 <kill>:
SYSCALL(kill)
     d85:	b8 06 00 00 00       	mov    $0x6,%eax
     d8a:	cd 40                	int    $0x40
     d8c:	c3                   	ret    

00000d8d <exec>:
SYSCALL(exec)
     d8d:	b8 07 00 00 00       	mov    $0x7,%eax
     d92:	cd 40                	int    $0x40
     d94:	c3                   	ret    

00000d95 <open>:
SYSCALL(open)
     d95:	b8 0f 00 00 00       	mov    $0xf,%eax
     d9a:	cd 40                	int    $0x40
     d9c:	c3                   	ret    

00000d9d <mknod>:
SYSCALL(mknod)
     d9d:	b8 11 00 00 00       	mov    $0x11,%eax
     da2:	cd 40                	int    $0x40
     da4:	c3                   	ret    

00000da5 <unlink>:
SYSCALL(unlink)
     da5:	b8 12 00 00 00       	mov    $0x12,%eax
     daa:	cd 40                	int    $0x40
     dac:	c3                   	ret    

00000dad <fstat>:
SYSCALL(fstat)
     dad:	b8 08 00 00 00       	mov    $0x8,%eax
     db2:	cd 40                	int    $0x40
     db4:	c3                   	ret    

00000db5 <link>:
SYSCALL(link)
     db5:	b8 13 00 00 00       	mov    $0x13,%eax
     dba:	cd 40                	int    $0x40
     dbc:	c3                   	ret    

00000dbd <mkdir>:
SYSCALL(mkdir)
     dbd:	b8 14 00 00 00       	mov    $0x14,%eax
     dc2:	cd 40                	int    $0x40
     dc4:	c3                   	ret    

00000dc5 <chdir>:
SYSCALL(chdir)
     dc5:	b8 09 00 00 00       	mov    $0x9,%eax
     dca:	cd 40                	int    $0x40
     dcc:	c3                   	ret    

00000dcd <dup>:
SYSCALL(dup)
     dcd:	b8 0a 00 00 00       	mov    $0xa,%eax
     dd2:	cd 40                	int    $0x40
     dd4:	c3                   	ret    

00000dd5 <getpid>:
SYSCALL(getpid)
     dd5:	b8 0b 00 00 00       	mov    $0xb,%eax
     dda:	cd 40                	int    $0x40
     ddc:	c3                   	ret    

00000ddd <sbrk>:
SYSCALL(sbrk)
     ddd:	b8 0c 00 00 00       	mov    $0xc,%eax
     de2:	cd 40                	int    $0x40
     de4:	c3                   	ret    

00000de5 <sleep>:
SYSCALL(sleep)
     de5:	b8 0d 00 00 00       	mov    $0xd,%eax
     dea:	cd 40                	int    $0x40
     dec:	c3                   	ret    

00000ded <uptime>:
SYSCALL(uptime)
     ded:	b8 0e 00 00 00       	mov    $0xe,%eax
     df2:	cd 40                	int    $0x40
     df4:	c3                   	ret    

00000df5 <cv_signal>:
SYSCALL(cv_signal)
     df5:	b8 16 00 00 00       	mov    $0x16,%eax
     dfa:	cd 40                	int    $0x40
     dfc:	c3                   	ret    

00000dfd <cv_wait>:
     dfd:	b8 17 00 00 00       	mov    $0x17,%eax
     e02:	cd 40                	int    $0x40
     e04:	c3                   	ret    
     ...
     e19:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
     ...
     e80:	e8 f0 fe ff ff       	call   d75 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     ef0:	e8 80 fe ff ff       	call   d75 <write>
  ...
  write(fd, &c, 1);
     ...
     f51:	e8 1f fe ff ff       	call   d75 <write>
  ...
  write(fd, &c, 1);
     f6a:	e8 06 fe ff ff       	call   d75 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    1003:	57                   	push   %edi
    1004:	53                   	push   %ebx
    1005:	e8 6b fd ff ff       	call   d75 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    1057:	e8 19 fd ff ff       	call   d75 <write>
        ap++;
    ...
    1081:	a1 a4 19 00 00       	mov    0x19a4,%eax
{
  ...
  freep = p;
    10bf:	a3 a4 19 00 00       	mov    %eax,0x19a4
}
    10c4:	5b                   	pop    %ebx
    10c5:	5e                   	pop    %esi
    10c6:	5f                   	pop    %edi
    ...
    10d6:	72 ce                	jb     10a6 <free+0x26>
{
  ...
  freep = p;
    10fa:	a3 a4 19 00 00       	mov    %eax,0x19a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  return freep;
    118b:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
    ...
    11b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    11b7:	89 15 a4 19 00 00    	mov    %edx,0x19a4
}
    ...
    base.s.ptr = freep = prevp = &base;
    11d0:	c7 05 a4 19 00 00 a8 	movl   $0x19a8,0x19a4
    11d7:	19 00 00 
    11da:	c7 05 a8 19 00 00 a8 	movl   $0x19a8,0x19a8
    11e1:	19 00 00 
    base.s.size = 0;
    11e4:	b8 a8 19 00 00       	mov    $0x19a8,%eax
    11e9:	c7 05 ac 19 00 00 00 	movl   $0x0,0x19ac
    11f0:	00 00 00 
