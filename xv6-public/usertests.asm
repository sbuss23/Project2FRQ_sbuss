...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 fa 38 00 00       	call   3925 <open>
    ...
    exit();
      40:	e8 a0 38 00 00       	call   38e5 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 cf 38 00 00       	call   3925 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 af 38 00 00       	call   390d <close>
  ...
  exit();
     10d:	e8 d3 37 00 00       	call   38e5 <exit>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 0b 38 00 00       	call   394d <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 ff 37 00 00       	call   3955 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 c7 37 00 00       	call   3935 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 d3 37 00 00       	call   3955 <chdir>
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b3:	e8 2d 37 00 00       	call   38e5 <exit>
    ...
    exit();
     1ca:	e8 16 37 00 00       	call   38e5 <exit>
    ...
    exit();
     1e1:	e8 ff 36 00 00       	call   38e5 <exit>
    ...
    exit();
     1f8:	e8 e8 36 00 00       	call   38e5 <exit>
...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 c2 36 00 00       	call   38dd <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 18 37 00 00       	call   394d <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 08 37 00 00       	call   3955 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     25c:	e8 d4 36 00 00       	call   3935 <unlink>
     261:	83 c4 10             	add    $0x10,%esp
     264:	85 c0                	test   %eax,%eax
     266:	78 28                	js     290 <exitiputtest+0x90>
    exit();
     268:	e8 78 36 00 00       	call   38e5 <exit>
     26d:	8d 76 00             	lea    0x0(%esi),%esi
  wait();
     270:	e8 78 36 00 00       	call   38ed <wait>
  printf(stdout, "exitiput test ok\n");
     ...
     29e:	e8 9d 37 00 00       	call   3a40 <printf>
      exit();
     2a3:	e8 3d 36 00 00       	call   38e5 <exit>
    ...
    exit();
     2ba:	e8 26 36 00 00       	call   38e5 <exit>
     ...
     2cc:	e8 6f 37 00 00       	call   3a40 <printf>
      exit();
     2d1:	e8 0f 36 00 00       	call   38e5 <exit>
      printf(stdout, "mkdir failed\n");
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     ...
     2e3:	e8 58 37 00 00       	call   3a40 <printf>
      exit();
     2e8:	e8 f8 35 00 00       	call   38e5 <exit>
...
000002f0 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     30d:	e8 3b 36 00 00       	call   394d <mkdir>
     312:	83 c4 10             	add    $0x10,%esp
     315:	85 c0                	test   %eax,%eax
     317:	0f 88 88 00 00 00    	js     3a5 <openiputtest+0xb5>
  pid = fork();
     31d:	e8 bb 35 00 00       	call   38dd <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     336:	e8 ea 35 00 00       	call   3925 <open>
    if(fd >= 0){
     ...
     350:	e8 eb 36 00 00       	call   3a40 <printf>
      exit();
     355:	e8 8b 35 00 00       	call   38e5 <exit>
     35a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  sleep(1);
     360:	83 ec 0c             	sub    $0xc,%esp
     363:	6a 01                	push   $0x1
     365:	e8 0b 36 00 00       	call   3975 <sleep>
  if(unlink("oidir") != 0){
     36a:	c7 04 24 37 3e 00 00 	movl   $0x3e37,(%esp)
     371:	e8 bf 35 00 00       	call   3935 <unlink>
     376:	83 c4 10             	add    $0x10,%esp
     379:	85 c0                	test   %eax,%eax
     37b:	75 56                	jne    3d3 <openiputtest+0xe3>
  wait();
     37d:	e8 6b 35 00 00       	call   38ed <wait>
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3a0:	e8 40 35 00 00       	call   38e5 <exit>
    ...
    exit();
     3b7:	e8 29 35 00 00       	call   38e5 <exit>
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
    ...
    exit();
     3ce:	e8 12 35 00 00       	call   38e5 <exit>
    ...
    exit();
     3e5:	e8 fb 34 00 00       	call   38e5 <exit>
...
000003f0 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     40f:	e8 11 35 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     41e:	50                   	push   %eax
     41f:	e8 e9 34 00 00       	call   390d <close>
  fd = open("doesnotexist", 0);
     424:	5a                   	pop    %edx
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 95 3e 00 00       	push   $0x3e95
     42d:	e8 f3 34 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     463:	e8 7d 34 00 00       	call   38e5 <exit>
    ...
    exit();
     47a:	e8 66 34 00 00       	call   38e5 <exit>
     47f:	90                   	nop
...
00000480 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4a4:	e8 7c 34 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4da:	56                   	push   %esi
     4db:	e8 25 34 00 00       	call   3905 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4f6:	56                   	push   %esi
     4f7:	e8 09 34 00 00       	call   3905 <write>
  ...
  close(fd);
     ...
     526:	e8 e2 33 00 00       	call   390d <close>
  fd = open("small", O_RDONLY);
     52b:	5b                   	pop    %ebx
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 df 3e 00 00       	push   $0x3edf
     534:	e8 ec 33 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  i = read(fd, buf, 2000);
     ...
     566:	53                   	push   %ebx
     567:	e8 91 33 00 00       	call   38fd <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     590:	e8 78 33 00 00       	call   390d <close>
  if(unlink("small") < 0){
     595:	c7 04 24 df 3e 00 00 	movl   $0x3edf,(%esp)
     59c:	e8 94 33 00 00       	call   3935 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5d4:	e8 67 34 00 00       	call   3a40 <printf>
      exit();
     5d9:	e8 07 33 00 00       	call   38e5 <exit>
     ...
     5ed:	e8 4e 34 00 00       	call   3a40 <printf>
      exit();
     5f2:	e8 ee 32 00 00       	call   38e5 <exit>
    ...
    exit();
     609:	e8 d7 32 00 00       	call   38e5 <exit>
    ...
    exit();
     620:	e8 c0 32 00 00       	call   38e5 <exit>
    ...
    exit();
     637:	e8 a9 32 00 00       	call   38e5 <exit>
    ...
    exit();
     64e:	e8 92 32 00 00       	call   38e5 <exit>
...
00000660 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     684:	e8 9c 32 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6b3:	56                   	push   %esi
     6b4:	e8 4c 32 00 00       	call   3905 <write>
  ...
  close(fd);
     ...
     6d5:	56                   	push   %esi
     6d6:	e8 32 32 00 00       	call   390d <close>
  fd = open("big", O_RDONLY);
     6db:	5b                   	pop    %ebx
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 27 40 00 00       	push   $0x4027
     6e4:	e8 3c 32 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     724:	56                   	push   %esi
     725:	e8 d3 31 00 00       	call   38fd <read>
    if(i == 0){
  ...
  close(fd);
     ...
     740:	56                   	push   %esi
     741:	e8 c7 31 00 00       	call   390d <close>
  if(unlink("big") < 0){
     746:	c7 04 24 27 40 00 00 	movl   $0x4027,(%esp)
     74d:	e8 e3 31 00 00       	call   3935 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     789:	e8 b2 32 00 00       	call   3a40 <printf>
      exit();
     78e:	e8 52 31 00 00       	call   38e5 <exit>
     ...
     7a0:	e8 9b 32 00 00       	call   3a40 <printf>
      exit();
     7a5:	e8 3b 31 00 00       	call   38e5 <exit>
     ...
     7b9:	e8 82 32 00 00       	call   3a40 <printf>
      exit();
     7be:	e8 22 31 00 00       	call   38e5 <exit>
     ...
     7d4:	e8 67 32 00 00       	call   3a40 <printf>
        exit();
     7d9:	e8 07 31 00 00       	call   38e5 <exit>
    ...
    exit();
     7f0:	e8 f0 30 00 00       	call   38e5 <exit>
    ...
    exit();
     807:	e8 d9 30 00 00       	call   38e5 <exit>
    ...
    exit();
     81e:	e8 c2 30 00 00       	call   38e5 <exit>
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     876:	e8 aa 30 00 00       	call   3925 <open>
    close(fd);
     87b:	89 04 24             	mov    %eax,(%esp)
     87e:	e8 8a 30 00 00       	call   390d <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     8b1:	e8 7f 30 00 00       	call   3935 <unlink>
  for(i = 0; i < 52; i++){
...
000008e0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     8fd:	e8 4b 30 00 00       	call   394d <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     911:	e8 3f 30 00 00       	call   3955 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     929:	e8 27 30 00 00       	call   3955 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     93d:	e8 f3 2f 00 00       	call   3935 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     973:	e8 6d 2f 00 00       	call   38e5 <exit>
    ...
    exit();
     98a:	e8 56 2f 00 00       	call   38e5 <exit>
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
    ...
    exit();
     9a1:	e8 3f 2f 00 00       	call   38e5 <exit>
    ...
    exit();
     9b8:	e8 28 2f 00 00       	call   38e5 <exit>
...
000009c0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9e2:	e8 36 2f 00 00       	call   391d <exec>
    ...
    exit();
     a02:	e8 de 2e 00 00       	call   38e5 <exit>
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     a4e:	e8 ba 2e 00 00       	call   390d <close>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a69:	e8 8f 2e 00 00       	call   38fd <read>
    ...
    close(fds[0]);
     ...
     ace:	e8 3a 2e 00 00       	call   390d <close>
     ...
     afe:	e8 02 2e 00 00       	call   3905 <write>
    ...
    exit();
     b1f:	e8 c1 2d 00 00       	call   38e5 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b33:	e8 d5 2d 00 00       	call   390d <close>
    wait();
     b38:	e8 b0 2d 00 00       	call   38ed <wait>
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     ...
     b61:	e8 da 2e 00 00       	call   3a40 <printf>
      exit();
     b66:	e8 7a 2d 00 00       	call   38e5 <exit>
    ...
    exit();
     b79:	e8 67 2d 00 00       	call   38e5 <exit>
    ...
    exit();
     b8c:	e8 54 2d 00 00       	call   38e5 <exit>
     ...
     b9a:	e8 a1 2e 00 00       	call   3a40 <printf>
        exit();
     b9f:	e8 41 2d 00 00       	call   38e5 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 13 2d 00 00       	call   38dd <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bd5:	e8 03 2d 00 00       	call   38dd <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     be8:	50                   	push   %eax
     be9:	e8 07 2d 00 00       	call   38f5 <pipe>
  pid3 = fork();
     bee:	e8 ea 2c 00 00       	call   38dd <fork>
  if(pid3 == 0){
  ...
  close(pfds[0]);
     ...
     c89:	e8 7f 2c 00 00       	call   390d <close>
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c9f:	e8 71 2c 00 00       	call   3915 <kill>
  kill(pid2);
     ca4:	89 34 24             	mov    %esi,(%esp)
     ca7:	e8 69 2c 00 00       	call   3915 <kill>
  kill(pid3);
     cac:	89 1c 24             	mov    %ebx,(%esp)
     caf:	e8 61 2c 00 00       	call   3915 <kill>
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
  ...
  wait();
     cc2:	e8 26 2c 00 00       	call   38ed <wait>
  wait();
     cc7:	e8 21 2c 00 00       	call   38ed <wait>
  wait();
     ccc:	e8 1c 2c 00 00       	call   38ed <wait>
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
...
00000cf0 <exitwait>:
{
    ...
    if(pid){
     d00:	74 6f                	je     d71 <exitwait+0x81>
      if(wait() != pid){
     d02:	e8 e6 2b 00 00       	call   38ed <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d10:	e8 c8 2b 00 00       	call   38dd <fork>
    if(pid < 0){
  ...
  printf(1, "exitwait ok\n");
     ...
     d70:	c3                   	ret    
      exit();
     d71:	e8 6f 2b 00 00       	call   38e5 <exit>
...
00000d80 <mem>:
{
  ...
  ppid = getpid();
     d97:	e8 c9 2b 00 00       	call   3965 <getpid>
     d9c:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     d9e:	e8 3a 2b 00 00       	call   38dd <fork>
    ...
    exit();
     e0f:	e8 d1 2a 00 00       	call   38e5 <exit>
     ...
     e2a:	e8 e6 2a 00 00       	call   3915 <kill>
      exit();
     e2f:	e8 b1 2a 00 00       	call   38e5 <exit>
     ...
     e3e:	5d                   	pop    %ebp
    wait();
     e3f:	e9 a9 2a 00 00       	jmp    38ed <wait>
...
00000e50 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e6c:	e8 c4 2a 00 00       	call   3935 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e71:	59                   	pop    %ecx
     e72:	5b                   	pop    %ebx
     e73:	68 02 02 00 00       	push   $0x202
     e78:	68 d3 41 00 00       	push   $0x41d3
     e7d:	e8 a3 2a 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  pid = fork();
     e94:	e8 44 2a 00 00       	call   38dd <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecd:	50                   	push   %eax
     ece:	56                   	push   %esi
     ecf:	e8 31 2a 00 00       	call   3905 <write>
  ...
  if(pid == 0)
    ...
    wait();
     ef6:	e8 f2 29 00 00       	call   38ed <wait>
  close(fd);
  ...
  close(fd);
     ...
     f06:	e8 02 2a 00 00       	call   390d <close>
  fd = open("sharedfd", 0);
     f0b:	58                   	pop    %eax
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 d3 41 00 00       	push   $0x41d3
     f14:	e8 0c 2a 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f3c:	e8 bc 29 00 00       	call   38fd <read>
  ...
  close(fd);
     ...
     f7c:	e8 8c 29 00 00       	call   390d <close>
  unlink("sharedfd");
     f81:	c7 04 24 d3 41 00 00 	movl   $0x41d3,(%esp)
     f88:	e8 a8 29 00 00       	call   3935 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ff3:	c3                   	ret    
    exit();
     ff4:	e8 ec 28 00 00       	call   38e5 <exit>
    ...
    exit();
    1007:	e8 d9 28 00 00       	call   38e5 <exit>
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104e:	56                   	push   %esi
    104f:	e8 e1 28 00 00       	call   3935 <unlink>
    pid = fork();
    1054:	e8 84 28 00 00       	call   38dd <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1078:	e8 70 28 00 00       	call   38ed <wait>
  for(i = 0; i < 2; i++){
    107d:	31 ff                	xor    %edi,%edi
    wait();
    107f:	e8 69 28 00 00       	call   38ed <wait>
    1084:	e8 64 28 00 00       	call   38ed <wait>
    1089:	e8 5f 28 00 00       	call   38ed <wait>
    ...
    109f:	e8 81 28 00 00       	call   3925 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10c0:	e8 38 28 00 00       	call   38fd <read>
    ...
    10f8:	e8 10 28 00 00       	call   390d <close>
    if(total != 12*500){
    ...
    1112:	e8 1e 28 00 00       	call   3935 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1151:	56                   	push   %esi
    1152:	e8 ce 27 00 00       	call   3925 <open>
      if(fd < 0){
    ...
    118b:	56                   	push   %esi
    118c:	e8 74 27 00 00       	call   3905 <write>
    ...
    119e:	75 de                	jne    117e <fourfiles+0x16e>
      exit();
    11a0:	e8 40 27 00 00       	call   38e5 <exit>
          printf(1, "wrong char\n");
    ...
    11af:	e8 8c 28 00 00       	call   3a40 <printf>
          exit();
    11b4:	e8 2c 27 00 00       	call   38e5 <exit>
    ...
    11c2:	e8 79 28 00 00       	call   3a40 <printf>
        exit();
    11c7:	e8 19 27 00 00       	call   38e5 <exit>
      printf(1, "fork failed\n");
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    ...
    11d5:	e8 66 28 00 00       	call   3a40 <printf>
      exit();
    11da:	e8 06 27 00 00       	call   38e5 <exit>
    ...
    11e8:	e8 53 28 00 00       	call   3a40 <printf>
      exit();
    11ed:	e8 f3 26 00 00       	call   38e5 <exit>
    ...
    11fb:	e8 40 28 00 00       	call   3a40 <printf>
          exit();
    1200:	e8 e0 26 00 00       	call   38e5 <exit>
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    122a:	e8 ae 26 00 00       	call   38dd <fork>
    if(pid < 0){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    wait();
    124d:	e8 9b 26 00 00       	call   38ed <wait>
    1252:	e8 96 26 00 00       	call   38ed <wait>
    1257:	e8 91 26 00 00       	call   38ed <wait>
    125c:	e8 8c 26 00 00       	call   38ed <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    1296:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1299:	e8 87 26 00 00       	call   3925 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12bf:	50                   	push   %eax
    12c0:	e8 48 26 00 00       	call   390d <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    12f8:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    12fb:	e8 35 26 00 00       	call   3935 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    1374:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1377:	e8 a9 25 00 00       	call   3925 <open>
        if(fd < 0){
    ...
    1386:	50                   	push   %eax
    1387:	e8 81 25 00 00       	call   390d <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13a3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13a6:	e8 8a 25 00 00       	call   3935 <unlink>
    ...
    13bb:	e8 80 26 00 00       	call   3a40 <printf>
            exit();
    13c0:	e8 20 25 00 00       	call   38e5 <exit>
    13c5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13c8:	e8 18 25 00 00       	call   38e5 <exit>
    ...
    13d8:	e8 63 26 00 00       	call   3a40 <printf>
        exit();
    13dd:	e8 03 25 00 00       	call   38e5 <exit>
          printf(1, "create failed\n");
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    ...
    13eb:	e8 50 26 00 00       	call   3a40 <printf>
          exit();
    13f0:	e8 f0 24 00 00       	call   38e5 <exit>
      printf(1, "fork failed\n");
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    ...
    13fe:	e8 3d 26 00 00       	call   3a40 <printf>
      exit();
    1403:	e8 dd 24 00 00       	call   38e5 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1419:	e8 22 26 00 00       	call   3a40 <printf>
        exit();
    141e:	e8 c2 24 00 00       	call   38e5 <exit>
...
00001430 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1450:	e8 d0 24 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    146c:	50                   	push   %eax
    146d:	e8 93 24 00 00       	call   3905 <write>
  close(fd);
    1472:	89 1c 24             	mov    %ebx,(%esp)
    1475:	e8 93 24 00 00       	call   390d <close>
  fd = open("unlinkread", O_RDWR);
    147a:	58                   	pop    %eax
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 85 42 00 00       	push   $0x4285
    1483:	e8 9d 24 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    149d:	e8 93 24 00 00       	call   3935 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ba:	e8 66 24 00 00       	call   3925 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    150b:	53                   	push   %ebx
    150c:	e8 f4 23 00 00       	call   3905 <write>
  ...
  close(fd);
    ...
    151c:	53                   	push   %ebx
    151d:	e8 eb 23 00 00       	call   390d <close>
  unlink("unlinkread");
    1522:	c7 04 24 85 42 00 00 	movl   $0x4285,(%esp)
    1529:	e8 07 24 00 00       	call   3935 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1554:	e8 8c 23 00 00       	call   38e5 <exit>
    ...
    exit();
    1567:	e8 79 23 00 00       	call   38e5 <exit>
    ...
    exit();
    157a:	e8 66 23 00 00       	call   38e5 <exit>
    ...
    exit();
    158d:	e8 53 23 00 00       	call   38e5 <exit>
    ...
    exit();
    15a0:	e8 40 23 00 00       	call   38e5 <exit>
    ...
    exit();
    15b3:	e8 2d 23 00 00       	call   38e5 <exit>
    15b8:	90                   	nop
...
000015c0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1613:	50                   	push   %eax
    1614:	e8 ec 22 00 00       	call   3905 <write>
  ...
  close(fd);
    ...
    1628:	53                   	push   %ebx
    1629:	e8 df 22 00 00       	call   390d <close>
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 4a 43 00 00       	push   $0x434a
    1635:	68 46 43 00 00       	push   $0x4346
    163a:	e8 06 23 00 00       	call   3945 <link>
  ...
  unlink("lf1");
    ...
    1652:	e8 de 22 00 00       	call   3935 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 46 43 00 00       	push   $0x4346
    1660:	e8 c0 22 00 00       	call   3925 <open>
  ...
  fd = open("lf2", 0);
    ...
    167a:	e8 a6 22 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1699:	50                   	push   %eax
    169a:	e8 5e 22 00 00       	call   38fd <read>
  ...
  close(fd);
    ...
    16ae:	53                   	push   %ebx
    16af:	e8 59 22 00 00       	call   390d <close>
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 4a 43 00 00       	push   $0x434a
    16bb:	68 4a 43 00 00       	push   $0x434a
    16c0:	e8 80 22 00 00       	call   3945 <link>
  ...
  unlink("lf2");
    ...
    16d8:	e8 58 22 00 00       	call   3935 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 46 43 00 00       	push   $0x4346
    16e4:	68 4a 43 00 00       	push   $0x434a
    16e9:	e8 57 22 00 00       	call   3945 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1702:	e8 3e 22 00 00       	call   3945 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1733:	e8 ad 21 00 00       	call   38e5 <exit>
    ...
    exit();
    1746:	e8 9a 21 00 00       	call   38e5 <exit>
    ...
    exit();
    1759:	e8 87 21 00 00       	call   38e5 <exit>
    ...
    exit();
    176c:	e8 74 21 00 00       	call   38e5 <exit>
    ...
    exit();
    177f:	e8 61 21 00 00       	call   38e5 <exit>
    ...
    exit();
    1792:	e8 4e 21 00 00       	call   38e5 <exit>
    ...
    exit();
    17a5:	e8 3b 21 00 00       	call   38e5 <exit>
    ...
    exit();
    17b8:	e8 28 21 00 00       	call   38e5 <exit>
    ...
    exit();
    17cb:	e8 15 21 00 00       	call   38e5 <exit>
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  file[2] = '\0';
    ...
    181e:	53                   	push   %ebx
    181f:	e8 01 21 00 00       	call   3925 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    182e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1831:	50                   	push   %eax
    1832:	e8 d6 20 00 00       	call   390d <close>
    1837:	83 c4 10             	add    $0x10,%esp
      wait();
    183a:	e8 ae 20 00 00       	call   38ed <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1852:	e8 de 20 00 00       	call   3935 <unlink>
    pid = fork();
    1857:	e8 81 20 00 00       	call   38dd <fork>
    if(pid && (i % 3) == 1){
    ...
    1881:	53                   	push   %ebx
    1882:	e8 9e 20 00 00       	call   3925 <open>
      if(fd < 0){
    ...
    189d:	e8 9e 21 00 00       	call   3a40 <printf>
        exit();
    18a2:	e8 3e 20 00 00       	call   38e5 <exit>
    ...
    18b9:	e8 87 20 00 00       	call   3945 <link>
    18be:	83 c4 10             	add    $0x10,%esp
      exit();
    18c1:	e8 1f 20 00 00       	call   38e5 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 64 20 00 00       	call   3945 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 04 20 00 00       	call   38ed <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 12 20 00 00       	call   3925 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 d1 1f 00 00       	call   38fd <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 94 1f 00 00       	call   390d <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 93 1f 00 00       	call   3935 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 8b 1f 00 00       	call   3935 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 83 1f 00 00       	call   3935 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 7b 1f 00 00       	call   3935 <unlink>
  ...
  for(i = 0; i < 40; i++){
    19c5:	83 c6 01             	add    $0x1,%esi
      wait();
    19c8:	e8 20 1f 00 00       	call   38ed <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19d8:	e8 00 1f 00 00       	call   38dd <fork>
    if(pid < 0){
    ...
    1a00:	6a 00                	push   $0x0
    1a02:	53                   	push   %ebx
    1a03:	e8 1d 1f 00 00       	call   3925 <open>
    1a08:	89 04 24             	mov    %eax,(%esp)
    1a0b:	e8 fd 1e 00 00       	call   390d <close>
      close(open(file, 0));
    1a10:	58                   	pop    %eax
    1a11:	5a                   	pop    %edx
    1a12:	6a 00                	push   $0x0
    1a14:	53                   	push   %ebx
    1a15:	e8 0b 1f 00 00       	call   3925 <open>
    1a1a:	89 04 24             	mov    %eax,(%esp)
    1a1d:	e8 eb 1e 00 00       	call   390d <close>
      close(open(file, 0));
    1a22:	59                   	pop    %ecx
    1a23:	58                   	pop    %eax
    1a24:	6a 00                	push   $0x0
    1a26:	53                   	push   %ebx
    1a27:	e8 f9 1e 00 00       	call   3925 <open>
    1a2c:	89 04 24             	mov    %eax,(%esp)
    1a2f:	e8 d9 1e 00 00       	call   390d <close>
      close(open(file, 0));
    1a34:	58                   	pop    %eax
    1a35:	5a                   	pop    %edx
    1a36:	6a 00                	push   $0x0
    1a38:	53                   	push   %ebx
    1a39:	e8 e7 1e 00 00       	call   3925 <open>
    1a3e:	89 04 24             	mov    %eax,(%esp)
    1a41:	e8 c7 1e 00 00       	call   390d <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a71:	e8 ca 1f 00 00       	call   3a40 <printf>
      exit();
    1a76:	e8 6a 1e 00 00       	call   38e5 <exit>
    ...
    exit();
    1a89:	e8 57 1e 00 00       	call   38e5 <exit>
    ...
    1a9a:	e8 a1 1f 00 00       	call   3a40 <printf>
        exit();
    1a9f:	e8 41 1e 00 00       	call   38e5 <exit>
    ...
    1ab0:	e8 8b 1f 00 00       	call   3a40 <printf>
        exit();
    1ab5:	e8 2b 1e 00 00       	call   38e5 <exit>
      close(fd);
    1aba:	83 ec 0c             	sub    $0xc,%esp
    1abd:	50                   	push   %eax
    1abe:	e8 4a 1e 00 00       	call   390d <close>
...
00001ad0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1aec:	e8 44 1e 00 00       	call   3935 <unlink>
  pid = fork();
    1af1:	e8 e7 1d 00 00       	call   38dd <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b2d:	e8 03 1e 00 00       	call   3935 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b62:	e8 be 1d 00 00       	call   3925 <open>
    1b67:	89 04 24             	mov    %eax,(%esp)
    1b6a:	e8 9e 1d 00 00       	call   390d <close>
  ...
  if(pid)
    ...
    wait();
    1b7e:	e8 6a 1d 00 00       	call   38ed <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bad:	e8 93 1d 00 00       	call   3945 <link>
    ...
    exit();
    1bc8:	e8 18 1d 00 00       	call   38e5 <exit>
    exit();
    1bcd:	e8 13 1d 00 00       	call   38e5 <exit>
...
00001be0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1bfc:	e8 34 1d 00 00       	call   3935 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 95 44 00 00       	push   $0x4495
    1c0d:	e8 13 1d 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
    1c25:	50                   	push   %eax
    1c26:	e8 e2 1c 00 00       	call   390d <close>
    ...
    if(link("bd", name) != 0){
    1c57:	e8 e9 1c 00 00       	call   3945 <link>
  ...
  unlink("bd");
    ...
    1c78:	e8 b8 1c 00 00       	call   3935 <unlink>
    ...
    if(unlink(name) != 0){
    1ca2:	e8 8e 1c 00 00       	call   3935 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1cdd:	e8 5e 1d 00 00       	call   3a40 <printf>
      exit();
    1ce2:	e8 fe 1b 00 00       	call   38e5 <exit>
    ...
    1cf1:	e8 4a 1d 00 00       	call   3a40 <printf>
      exit();
    1cf6:	e8 ea 1b 00 00       	call   38e5 <exit>
    ...
    exit();
    1d09:	e8 d7 1b 00 00       	call   38e5 <exit>
...
00001d10 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d2a:	e8 06 1c 00 00       	call   3935 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d36:	e8 12 1c 00 00       	call   394d <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d53:	e8 cd 1b 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d6f:	50                   	push   %eax
    1d70:	e8 90 1b 00 00       	call   3905 <write>
  close(fd);
    1d75:	89 1c 24             	mov    %ebx,(%esp)
    1d78:	e8 90 1b 00 00       	call   390d <close>
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 08 46 00 00 	movl   $0x4608,(%esp)
    1d84:	e8 ac 1b 00 00       	call   3935 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d9c:	e8 ac 1b 00 00       	call   394d <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db9:	e8 67 1b 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1dd5:	50                   	push   %eax
    1dd6:	e8 2a 1b 00 00       	call   3905 <write>
  close(fd);
    1ddb:	89 1c 24             	mov    %ebx,(%esp)
    1dde:	e8 2a 1b 00 00       	call   390d <close>
  fd = open("dd/dd/../ff", 0);
    1de3:	58                   	pop    %eax
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 62 45 00 00       	push   $0x4562
    1dec:	e8 34 1b 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e0b:	50                   	push   %eax
    1e0c:	e8 ec 1a 00 00       	call   38fd <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e2d:	53                   	push   %ebx
    1e2e:	e8 da 1a 00 00       	call   390d <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 a2 45 00 00       	push   $0x45a2
    1e3a:	68 3e 45 00 00       	push   $0x453e
    1e3f:	e8 01 1b 00 00       	call   3945 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e57:	e8 d9 1a 00 00       	call   3935 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e71:	e8 af 1a 00 00       	call   3925 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e89:	e8 c7 1a 00 00       	call   3955 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1ea1:	e8 af 1a 00 00       	call   3955 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb9:	e8 97 1a 00 00       	call   3955 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ed1:	e8 7f 1a 00 00       	call   3955 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1eeb:	e8 35 1a 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f0a:	50                   	push   %eax
    1f0b:	e8 ed 19 00 00       	call   38fd <read>
  ...
  close(fd);
    ...
    1f1f:	53                   	push   %ebx
    1f20:	e8 e8 19 00 00       	call   390d <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f25:	59                   	pop    %ecx
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 3e 45 00 00       	push   $0x453e
    1f2e:	e8 f2 19 00 00       	call   3925 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f4b:	e8 d5 19 00 00       	call   3925 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f68:	e8 b8 19 00 00       	call   3925 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f85:	e8 9b 19 00 00       	call   3925 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f9f:	e8 81 19 00 00       	call   3925 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb9:	e8 67 19 00 00       	call   3925 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fd6:	e8 6a 19 00 00       	call   3945 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ff3:	e8 4d 19 00 00       	call   3945 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2010:	e8 30 19 00 00       	call   3945 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2028:	e8 20 19 00 00       	call   394d <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2040:	e8 08 19 00 00       	call   394d <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2058:	e8 f0 18 00 00       	call   394d <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2070:	e8 c0 18 00 00       	call   3935 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2088:	e8 a8 18 00 00       	call   3935 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20a0:	e8 b0 18 00 00       	call   3955 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b8:	e8 98 18 00 00       	call   3955 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20d0:	e8 60 18 00 00       	call   3935 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e8:	e8 48 18 00 00       	call   3935 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2100:	e8 30 18 00 00       	call   3935 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2118:	e8 18 18 00 00       	call   3935 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2130:	e8 00 18 00 00       	call   3935 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2165:	e8 7b 17 00 00       	call   38e5 <exit>
    ...
    exit();
    2178:	e8 68 17 00 00       	call   38e5 <exit>
    ...
    exit();
    218b:	e8 55 17 00 00       	call   38e5 <exit>
    ...
    exit();
    219e:	e8 42 17 00 00       	call   38e5 <exit>
    ...
    exit();
    21b1:	e8 2f 17 00 00       	call   38e5 <exit>
    ...
    exit();
    21c4:	e8 1c 17 00 00       	call   38e5 <exit>
    ...
    exit();
    21d7:	e8 09 17 00 00       	call   38e5 <exit>
    ...
    exit();
    21ea:	e8 f6 16 00 00       	call   38e5 <exit>
    ...
    exit();
    21fd:	e8 e3 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2210:	e8 d0 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2223:	e8 bd 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2236:	e8 aa 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2249:	e8 97 16 00 00       	call   38e5 <exit>
    ...
    exit();
    225c:	e8 84 16 00 00       	call   38e5 <exit>
    ...
    exit();
    226f:	e8 71 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2282:	e8 5e 16 00 00       	call   38e5 <exit>
    ...
    exit();
    2295:	e8 4b 16 00 00       	call   38e5 <exit>
    ...
    exit();
    22a8:	e8 38 16 00 00       	call   38e5 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    ...
    exit();
    22bb:	e8 25 16 00 00       	call   38e5 <exit>
    ...
    exit();
    22ce:	e8 12 16 00 00       	call   38e5 <exit>
    ...
    exit();
    22e1:	e8 ff 15 00 00       	call   38e5 <exit>
    ...
    exit();
    22f4:	e8 ec 15 00 00       	call   38e5 <exit>
    ...
    exit();
    2307:	e8 d9 15 00 00       	call   38e5 <exit>
    ...
    exit();
    231a:	e8 c6 15 00 00       	call   38e5 <exit>
    ...
    exit();
    232d:	e8 b3 15 00 00       	call   38e5 <exit>
    ...
    exit();
    2340:	e8 a0 15 00 00       	call   38e5 <exit>
    ...
    exit();
    2353:	e8 8d 15 00 00       	call   38e5 <exit>
    ...
    exit();
    2366:	e8 7a 15 00 00       	call   38e5 <exit>
    ...
    exit();
    2379:	e8 67 15 00 00       	call   38e5 <exit>
    ...
    exit();
    238c:	e8 54 15 00 00       	call   38e5 <exit>
    ...
    exit();
    239f:	e8 41 15 00 00       	call   38e5 <exit>
    ...
    exit();
    23b2:	e8 2e 15 00 00       	call   38e5 <exit>
    ...
    exit();
    23c5:	e8 1b 15 00 00       	call   38e5 <exit>
    ...
    exit();
    23d8:	e8 08 15 00 00       	call   38e5 <exit>
    ...
    exit();
    23eb:	e8 f5 14 00 00       	call   38e5 <exit>
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2410:	e8 20 15 00 00       	call   3935 <unlink>
    ...
    242d:	e8 f3 14 00 00       	call   3925 <open>
    if(fd < 0){
    ...
    2444:	50                   	push   %eax
    2445:	e8 bb 14 00 00       	call   3905 <write>
      if(cc != sz){
    ...
    245a:	56                   	push   %esi
    245b:	e8 a5 14 00 00       	call   3905 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2470:	56                   	push   %esi
    2471:	e8 97 14 00 00       	call   390d <close>
    unlink("bigwrite");
    2476:	c7 04 24 04 48 00 00 	movl   $0x4804,(%esp)
    247d:	e8 b3 14 00 00       	call   3935 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24af:	e8 8c 15 00 00       	call   3a40 <printf>
        exit();
    24b4:	e8 2c 14 00 00       	call   38e5 <exit>
    ...
    24c3:	e8 78 15 00 00       	call   3a40 <printf>
      exit();
    24c8:	e8 18 14 00 00       	call   38e5 <exit>
...
000024d0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24ec:	e8 44 14 00 00       	call   3935 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24f1:	58                   	pop    %eax
    24f2:	5a                   	pop    %edx
    24f3:	68 02 02 00 00       	push   $0x202
    24f8:	68 60 48 00 00       	push   $0x4860
    24fd:	e8 23 14 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2538:	56                   	push   %esi
    2539:	e8 c7 13 00 00       	call   3905 <write>
  ...
  close(fd);
    ...
    2557:	56                   	push   %esi
    2558:	e8 b0 13 00 00       	call   390d <close>
  fd = open("bigfile", 0);
    255d:	5e                   	pop    %esi
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 60 48 00 00       	push   $0x4860
    2566:	e8 ba 13 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25bb:	56                   	push   %esi
    25bc:	e8 3c 13 00 00       	call   38fd <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25cd:	56                   	push   %esi
    25ce:	e8 3a 13 00 00       	call   390d <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25ea:	e8 46 13 00 00       	call   3935 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2612:	e8 29 14 00 00       	call   3a40 <printf>
      exit();
    2617:	e8 c9 12 00 00       	call   38e5 <exit>
    ...
    2626:	e8 15 14 00 00       	call   3a40 <printf>
      exit();
    262b:	e8 b5 12 00 00       	call   38e5 <exit>
    ...
    263a:	e8 01 14 00 00       	call   3a40 <printf>
      exit();
    263f:	e8 a1 12 00 00       	call   38e5 <exit>
    ...
    264e:	e8 ed 13 00 00       	call   3a40 <printf>
      exit();
    2653:	e8 8d 12 00 00       	call   38e5 <exit>
    ...
    exit();
    2666:	e8 7a 12 00 00       	call   38e5 <exit>
    ...
    exit();
    2679:	e8 67 12 00 00       	call   38e5 <exit>
    ...
    exit();
    268c:	e8 54 12 00 00       	call   38e5 <exit>
...
000026a0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26b9:	e8 8f 12 00 00       	call   394d <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26d1:	e8 77 12 00 00       	call   394d <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26ee:	e8 32 12 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2701:	50                   	push   %eax
    2702:	e8 06 12 00 00       	call   390d <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2707:	58                   	pop    %eax
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 b8 51 00 00       	push   $0x51b8
    2710:	e8 10 12 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    271f:	50                   	push   %eax
    2720:	e8 e8 11 00 00       	call   390d <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 2c 49 00 00 	movl   $0x492c,(%esp)
    272c:	e8 1c 12 00 00       	call   394d <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2740:	e8 08 12 00 00       	call   394d <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    276e:	e8 72 11 00 00       	call   38e5 <exit>
    ...
    exit();
    2781:	e8 5f 11 00 00       	call   38e5 <exit>
    ...
    exit();
    2794:	e8 4c 11 00 00       	call   38e5 <exit>
    ...
    exit();
    27a7:	e8 39 11 00 00       	call   38e5 <exit>
    ...
    exit();
    27ba:	e8 26 11 00 00       	call   38e5 <exit>
    ...
    exit();
    27cd:	e8 13 11 00 00       	call   38e5 <exit>
...
000027e0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    27f9:	e8 4f 11 00 00       	call   394d <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2811:	e8 3f 11 00 00       	call   3955 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2829:	e8 07 11 00 00       	call   3935 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2841:	e8 ef 10 00 00       	call   3935 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2859:	e8 f7 10 00 00       	call   3955 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2871:	e8 bf 10 00 00       	call   3935 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2885:	e8 ab 10 00 00       	call   3935 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    2899:	e8 97 10 00 00       	call   3935 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28c7:	e8 19 10 00 00       	call   38e5 <exit>
    ...
    exit();
    28da:	e8 06 10 00 00       	call   38e5 <exit>
    ...
    exit();
    28ed:	e8 f3 0f 00 00       	call   38e5 <exit>
    printf(1, "unlink dots/. worked!\n");
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    ...
    exit();
    2900:	e8 e0 0f 00 00       	call   38e5 <exit>
    printf(1, "chdir / failed\n");
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    ...
    exit();
    2913:	e8 cd 0f 00 00       	call   38e5 <exit>
    printf(1, "rm .. worked!\n");
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    ...
    exit();
    2926:	e8 ba 0f 00 00       	call   38e5 <exit>
    printf(1, "rm . worked!\n");
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    ...
    exit();
    2939:	e8 a7 0f 00 00       	call   38e5 <exit>
    ...
    exit();
    294c:	e8 94 0f 00 00       	call   38e5 <exit>
...
00002960 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297f:	e8 a1 0f 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2992:	50                   	push   %eax
    2993:	e8 75 0f 00 00       	call   390d <close>
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 15 4a 00 00 	movl   $0x4a15,(%esp)
    299f:	e8 b1 0f 00 00       	call   3955 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b9:	e8 67 0f 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d6:	e8 4a 0f 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29ee:	e8 5a 0f 00 00       	call   394d <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a06:	e8 2a 0f 00 00       	call   3935 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a23:	e8 1d 0f 00 00       	call   3945 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a3b:	e8 f5 0e 00 00       	call   3935 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a55:	e8 cb 0e 00 00       	call   3925 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a6f:	e8 b1 0e 00 00       	call   3925 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a80:	50                   	push   %eax
    2a81:	e8 7f 0e 00 00       	call   3905 <write>
  ...
  close(fd);
    ...
    2a90:	53                   	push   %ebx
    2a91:	e8 77 0e 00 00       	call   390d <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aba:	e8 26 0e 00 00       	call   38e5 <exit>
    ...
    exit();
    2acd:	e8 13 0e 00 00       	call   38e5 <exit>
    ...
    exit();
    2ae0:	e8 00 0e 00 00       	call   38e5 <exit>
    ...
    exit();
    2af3:	e8 ed 0d 00 00       	call   38e5 <exit>
    ...
    exit();
    2b06:	e8 da 0d 00 00       	call   38e5 <exit>
    ...
    exit();
    2b19:	e8 c7 0d 00 00       	call   38e5 <exit>
    ...
    exit();
    2b2c:	e8 b4 0d 00 00       	call   38e5 <exit>
    ...
    exit();
    2b3f:	e8 a1 0d 00 00       	call   38e5 <exit>
    ...
    exit();
    2b52:	e8 8e 0d 00 00       	call   38e5 <exit>
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b88:	e8 c0 0d 00 00       	call   394d <mkdir>
    ...
    2ba0:	e8 b0 0d 00 00       	call   3955 <chdir>
  ...
  chdir("/");
    ...
    2c38:	e8 18 0d 00 00       	call   3955 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c5d:	e8 de 0d 00 00       	call   3a40 <printf>
      exit();
    2c62:	e8 7e 0c 00 00       	call   38e5 <exit>
    ...
    2c71:	e8 ca 0d 00 00       	call   3a40 <printf>
      exit();
    2c76:	e8 6a 0c 00 00       	call   38e5 <exit>
    2c7b:	90                   	nop
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cad:	e8 2b 0c 00 00       	call   38dd <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cc0:	e8 28 0c 00 00       	call   38ed <wait>
  ...
  if(wait() != -1){
    2cce:	e8 1a 0c 00 00       	call   38ed <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    exit();
    2cff:	e8 e1 0b 00 00       	call   38e5 <exit>
      exit();
    2d04:	e8 dc 0b 00 00       	call   38e5 <exit>
    ...
    2d13:	e8 28 0d 00 00       	call   3a40 <printf>
      exit();
    2d18:	e8 c8 0b 00 00       	call   38e5 <exit>
    ...
    exit();
    2d2b:	e8 b5 0b 00 00       	call   38e5 <exit>
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d52:	e8 16 0c 00 00       	call   396d <sbrk>
  a = sbrk(0);
    2d57:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d5e:	89 c3                	mov    %eax,%ebx
  a = sbrk(0);
    2d60:	e8 08 0c 00 00       	call   396d <sbrk>
    ...
    2d75:	6a 01                	push   $0x1
    2d77:	e8 f1 0b 00 00       	call   396d <sbrk>
    if(b != a){
  ...
  pid = fork();
    2d98:	e8 40 0b 00 00       	call   38dd <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    2dad:	6a 01                	push   $0x1
    2daf:	e8 b9 0b 00 00       	call   396d <sbrk>
  c = sbrk(1);
    2db4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dbb:	e8 ad 0b 00 00       	call   396d <sbrk>
  if(c != a + 1){
  ...
  wait();
    2dd3:	e8 15 0b 00 00       	call   38ed <wait>
  a = sbrk(0);
    2dd8:	83 ec 0c             	sub    $0xc,%esp
    2ddb:	6a 00                	push   $0x0
    2ddd:	e8 8b 0b 00 00       	call   396d <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dee:	e8 7a 0b 00 00       	call   396d <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e08:	6a 00                	push   $0x0
    2e0a:	e8 5e 0b 00 00       	call   396d <sbrk>
  c = sbrk(-4096);
    2e0f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e16:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2e18:	e8 50 0b 00 00       	call   396d <sbrk>
  ...
  c = sbrk(0);
    ...
    2e2c:	6a 00                	push   $0x0
    2e2e:	e8 3a 0b 00 00       	call   396d <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e47:	6a 00                	push   $0x0
    2e49:	e8 1f 0b 00 00       	call   396d <sbrk>
    2e4e:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2e50:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2e57:	e8 11 0b 00 00       	call   396d <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e6c:	6a 00                	push   $0x0
    2e6e:	e8 fa 0a 00 00       	call   396d <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ec5:	e8 9b 0a 00 00       	call   3965 <getpid>
    2eca:	89 c7                	mov    %eax,%edi
    pid = fork();
    2ecc:	e8 0c 0a 00 00       	call   38dd <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    2ee5:	e8 03 0a 00 00       	call   38ed <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2ef8:	50                   	push   %eax
    2ef9:	e8 f7 09 00 00       	call   38f5 <pipe>
    ...
    2f21:	e8 d7 09 00 00       	call   38fd <read>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2f33:	e8 a5 09 00 00       	call   38dd <fork>
  ...
  c = sbrk(4096);
    ...
    2f9f:	50                   	push   %eax
    2fa0:	e8 70 09 00 00       	call   3915 <kill>
    wait();
    2fa5:	e8 43 09 00 00       	call   38ed <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fbd:	6a 00                	push   $0x0
    2fbf:	e8 a9 09 00 00       	call   396d <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3002:	e8 de 08 00 00       	call   38e5 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    3007:	83 ec 0c             	sub    $0xc,%esp
    300a:	6a 00                	push   $0x0
    300c:	e8 5c 09 00 00       	call   396d <sbrk>
    3011:	29 c3                	sub    %eax,%ebx
    3013:	89 1c 24             	mov    %ebx,(%esp)
    3016:	e8 52 09 00 00       	call   396d <sbrk>
    ...
    exit();
    3032:	e8 ae 08 00 00       	call   38e5 <exit>
    printf(1, "pipe() failed\n");
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    ...
    exit();
    3045:	e8 9b 08 00 00       	call   38e5 <exit>
    ...
    3062:	e8 ae 08 00 00       	call   3915 <kill>
      exit();
    3067:	e8 79 08 00 00       	call   38e5 <exit>
      printf(stdout, "fork failed\n");
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    ...
    3079:	e8 c2 09 00 00       	call   3a40 <printf>
      exit();
    307e:	e8 62 08 00 00       	call   38e5 <exit>
    ...
    exit();
    3095:	e8 4b 08 00 00       	call   38e5 <exit>
    ...
    exit();
    30ac:	e8 34 08 00 00       	call   38e5 <exit>
    ...
    exit();
    30c3:	e8 1d 08 00 00       	call   38e5 <exit>
    ...
    exit();
    30da:	e8 06 08 00 00       	call   38e5 <exit>
    ...
    exit();
    30f1:	e8 ef 07 00 00       	call   38e5 <exit>
    ...
    exit();
    3108:	e8 d8 07 00 00       	call   38e5 <exit>
    exit();
    310d:	e8 d3 07 00 00       	call   38e5 <exit>
    ...
    exit();
    3124:	e8 bc 07 00 00       	call   38e5 <exit>
    ...
    exit();
    313b:	e8 a5 07 00 00       	call   38e5 <exit>
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    3170:	e8 68 07 00 00       	call   38dd <fork>
    ...
    317e:	6a 00                	push   $0x0
    3180:	e8 f0 07 00 00       	call   3975 <sleep>
    sleep(0);
    3185:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    318c:	e8 e4 07 00 00       	call   3975 <sleep>
    kill(pid);
    3191:	89 34 24             	mov    %esi,(%esp)
    3194:	e8 7c 07 00 00       	call   3915 <kill>
    wait();
    3199:	e8 4f 07 00 00       	call   38ed <wait>
    if(link("nosuchfile", (char*)p) != -1){
    319e:	58                   	pop    %eax
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 4d 4c 00 00       	push   $0x4c4d
    31a6:	e8 9a 07 00 00       	call   3945 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31dd:	c3                   	ret    
      exit();
    31de:	e8 02 07 00 00       	call   38e5 <exit>
    ...
    31f1:	e8 4a 08 00 00       	call   3a40 <printf>
      exit();
    31f6:	e8 ea 06 00 00       	call   38e5 <exit>
    31fb:	90                   	nop
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3269:	e8 d2 07 00 00       	call   3a40 <printf>
      exit();
    326e:	e8 72 06 00 00       	call   38e5 <exit>
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    328b:	e8 a5 06 00 00       	call   3935 <unlink>
  pid = fork();
    3290:	e8 48 06 00 00       	call   38dd <fork>
  if(pid == 0){
  ...
  wait();
    32a2:	e8 46 06 00 00       	call   38ed <wait>
  fd = open("bigarg-ok", 0);
    32a7:	83 ec 08             	sub    $0x8,%esp
    32aa:	6a 00                	push   $0x0
    32ac:	68 a6 4c 00 00       	push   $0x4ca6
    32b1:	e8 6f 06 00 00       	call   3925 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32c4:	50                   	push   %eax
    32c5:	e8 43 06 00 00       	call   390d <close>
  unlink("bigarg-ok");
    32ca:	c7 04 24 a6 4c 00 00 	movl   $0x4ca6,(%esp)
    32d1:	e8 5f 06 00 00       	call   3935 <unlink>
}
    ...
    3318:	e8 00 06 00 00       	call   391d <exec>
    ...
    333b:	e8 e5 05 00 00       	call   3925 <open>
    close(fd);
    3340:	89 04 24             	mov    %eax,(%esp)
    3343:	e8 c5 05 00 00       	call   390d <close>
    exit();
    3348:	e8 98 05 00 00       	call   38e5 <exit>
    ...
    exit();
    335f:	e8 81 05 00 00       	call   38e5 <exit>
    ...
    exit();
    3376:	e8 6a 05 00 00       	call   38e5 <exit>
    337b:	90                   	nop
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    342a:	50                   	push   %eax
    342b:	e8 f5 04 00 00       	call   3925 <open>
    if(fd < 0){
    ...
    344f:	57                   	push   %edi
    3450:	e8 b0 04 00 00       	call   3905 <write>
      if(cc < 512)
    ...
    3472:	e8 96 04 00 00       	call   390d <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3519:	50                   	push   %eax
    351a:	e8 16 04 00 00       	call   3935 <unlink>
  while(nfiles >= 0){
...
00003550 <uio>:
{
  ...
  pid = fork();
    3562:	e8 76 03 00 00       	call   38dd <fork>
  if(pid == 0){
  ...
  wait();
    3570:	e8 78 03 00 00       	call   38ed <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35a8:	e8 38 03 00 00       	call   38e5 <exit>
    printf (1, "fork failed\n");
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    ...
    exit();
    35bb:	e8 25 03 00 00       	call   38e5 <exit>
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35ce:	e8 52 03 00 00       	call   3925 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    35df:	6a 00                	push   $0x0
    35e1:	e8 87 03 00 00       	call   396d <sbrk>
    35e6:	83 c4 0c             	add    $0xc,%esp
    35e9:	83 e8 01             	sub    $0x1,%eax
    35ec:	6a ff                	push   $0xffffffff
    35ee:	50                   	push   %eax
    35ef:	53                   	push   %ebx
    35f0:	e8 08 03 00 00       	call   38fd <read>
  close(fd);
    35f5:	89 1c 24             	mov    %ebx,(%esp)
    35f8:	e8 10 03 00 00       	call   390d <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3621:	e8 bf 02 00 00       	call   38e5 <exit>
    ...
    3768:	89 f3                	mov    %esi,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3780:	50                   	push   %eax
    3781:	6a 00                	push   $0x0
    3783:	e8 75 01 00 00       	call   38fd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    37ed:	e8 33 01 00 00       	call   3925 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3801:	50                   	push   %eax
    3802:	e8 36 01 00 00       	call   393d <fstat>
  close(fd);
    3807:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    380a:	89 c6                	mov    %eax,%esi
  close(fd);
    380c:	e8 fc 00 00 00       	call   390d <close>
  return r;
...
init_lock(struct spinlock * lk) { 
  ...
  lk->locked = 0;
    ...
    38a6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    38ac:	5d                   	pop    %ebp
    38ad:	c3                   	ret    
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    38b1:	b9 01 00 00 00       	mov    $0x1,%ecx
    38b6:	89 e5                	mov    %esp,%ebp
    38b8:	8b 55 08             	mov    0x8(%ebp),%edx
    38bb:	90                   	nop
    38bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    38c0:	89 c8                	mov    %ecx,%eax
    38c2:	f0 87 02             	lock xchg %eax,(%edx)
  while(xchg(&lk->locked, 1) != 0); 
    38c5:	85 c0                	test   %eax,%eax
    38c7:	75 f7                	jne    38c0 <lock+0x10>
}
    38c9:	5d                   	pop    %ebp
    38ca:	c3                   	ret    
    38cb:	90                   	nop
...
void unlock(struct spinlock * lk) { 
    ...
    38d3:	89 e5                	mov    %esp,%ebp
    38d5:	8b 55 08             	mov    0x8(%ebp),%edx
    38d8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lk->locked, 0);
}
    38db:	5d                   	pop    %ebp
    38dc:	c3                   	ret    
...
SYSCALL(fork)
    38dd:	b8 01 00 00 00       	mov    $0x1,%eax
    38e2:	cd 40                	int    $0x40
    38e4:	c3                   	ret    

000038e5 <exit>:
SYSCALL(exit)
    38e5:	b8 02 00 00 00       	mov    $0x2,%eax
    38ea:	cd 40                	int    $0x40
    38ec:	c3                   	ret    

000038ed <wait>:
SYSCALL(wait)
    38ed:	b8 03 00 00 00       	mov    $0x3,%eax
    38f2:	cd 40                	int    $0x40
    38f4:	c3                   	ret    

000038f5 <pipe>:
SYSCALL(pipe)
    38f5:	b8 04 00 00 00       	mov    $0x4,%eax
    38fa:	cd 40                	int    $0x40
    38fc:	c3                   	ret    

000038fd <read>:
SYSCALL(read)
    38fd:	b8 05 00 00 00       	mov    $0x5,%eax
    3902:	cd 40                	int    $0x40
    3904:	c3                   	ret    

00003905 <write>:
SYSCALL(write)
    3905:	b8 10 00 00 00       	mov    $0x10,%eax
    390a:	cd 40                	int    $0x40
    390c:	c3                   	ret    

0000390d <close>:
SYSCALL(close)
    390d:	b8 15 00 00 00       	mov    $0x15,%eax
    3912:	cd 40                	int    $0x40
    3914:	c3                   	ret    

00003915 <kill>:
SYSCALL(kill)
    3915:	b8 06 00 00 00       	mov    $0x6,%eax
    391a:	cd 40                	int    $0x40
    391c:	c3                   	ret    

0000391d <exec>:
SYSCALL(exec)
    391d:	b8 07 00 00 00       	mov    $0x7,%eax
    3922:	cd 40                	int    $0x40
    3924:	c3                   	ret    

00003925 <open>:
SYSCALL(open)
    3925:	b8 0f 00 00 00       	mov    $0xf,%eax
    392a:	cd 40                	int    $0x40
    392c:	c3                   	ret    

0000392d <mknod>:
SYSCALL(mknod)
    392d:	b8 11 00 00 00       	mov    $0x11,%eax
    3932:	cd 40                	int    $0x40
    3934:	c3                   	ret    

00003935 <unlink>:
SYSCALL(unlink)
    3935:	b8 12 00 00 00       	mov    $0x12,%eax
    393a:	cd 40                	int    $0x40
    393c:	c3                   	ret    

0000393d <fstat>:
SYSCALL(fstat)
    393d:	b8 08 00 00 00       	mov    $0x8,%eax
    3942:	cd 40                	int    $0x40
    3944:	c3                   	ret    

00003945 <link>:
SYSCALL(link)
    3945:	b8 13 00 00 00       	mov    $0x13,%eax
    394a:	cd 40                	int    $0x40
    394c:	c3                   	ret    

0000394d <mkdir>:
SYSCALL(mkdir)
    394d:	b8 14 00 00 00       	mov    $0x14,%eax
    3952:	cd 40                	int    $0x40
    3954:	c3                   	ret    

00003955 <chdir>:
SYSCALL(chdir)
    3955:	b8 09 00 00 00       	mov    $0x9,%eax
    395a:	cd 40                	int    $0x40
    395c:	c3                   	ret    

0000395d <dup>:
SYSCALL(dup)
    395d:	b8 0a 00 00 00       	mov    $0xa,%eax
    3962:	cd 40                	int    $0x40
    3964:	c3                   	ret    

00003965 <getpid>:
SYSCALL(getpid)
    3965:	b8 0b 00 00 00       	mov    $0xb,%eax
    396a:	cd 40                	int    $0x40
    396c:	c3                   	ret    

0000396d <sbrk>:
SYSCALL(sbrk)
    396d:	b8 0c 00 00 00       	mov    $0xc,%eax
    3972:	cd 40                	int    $0x40
    3974:	c3                   	ret    

00003975 <sleep>:
SYSCALL(sleep)
    3975:	b8 0d 00 00 00       	mov    $0xd,%eax
    397a:	cd 40                	int    $0x40
    397c:	c3                   	ret    

0000397d <uptime>:
SYSCALL(uptime)
    397d:	b8 0e 00 00 00       	mov    $0xe,%eax
    3982:	cd 40                	int    $0x40
    3984:	c3                   	ret    

00003985 <cv_signal>:
SYSCALL(cv_signal)
    3985:	b8 16 00 00 00       	mov    $0x16,%eax
    398a:	cd 40                	int    $0x40
    398c:	c3                   	ret    

0000398d <cv_wait>:
    398d:	b8 17 00 00 00       	mov    $0x17,%eax
    3992:	cd 40                	int    $0x40
    3994:	c3                   	ret    
    ...
    39a9:	85 d2                	test   %edx,%edx
{
  ...
  write(fd, &c, 1);
    ...
    3a10:	e8 f0 fe ff ff       	call   3905 <write>
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3a80:	e8 80 fe ff ff       	call   3905 <write>
  ...
  write(fd, &c, 1);
    ...
    3ae1:	e8 1f fe ff ff       	call   3905 <write>
  ...
  write(fd, &c, 1);
    3afa:	e8 06 fe ff ff       	call   3905 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3b93:	57                   	push   %edi
    3b94:	53                   	push   %ebx
    3b95:	e8 6b fd ff ff       	call   3905 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3be7:	e8 19 fd ff ff       	call   3905 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c11:	a1 40 5f 00 00       	mov    0x5f40,%eax
{
  ...
  freep = p;
    3c4f:	a3 40 5f 00 00       	mov    %eax,0x5f40
}
    3c54:	5b                   	pop    %ebx
    3c55:	5e                   	pop    %esi
    3c56:	5f                   	pop    %edi
    ...
    3c66:	72 ce                	jb     3c36 <free+0x26>
{
  ...
  freep = p;
    3c8a:	a3 40 5f 00 00       	mov    %eax,0x5f40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cac:	8b 15 40 5f 00 00    	mov    0x5f40,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3d1b:	8b 15 40 5f 00 00    	mov    0x5f40,%edx
    ...
    3d44:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3d47:	89 15 40 5f 00 00    	mov    %edx,0x5f40
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d60:	c7 05 40 5f 00 00 44 	movl   $0x5f44,0x5f40
    3d67:	5f 00 00 
    3d6a:	c7 05 44 5f 00 00 44 	movl   $0x5f44,0x5f44
    3d71:	5f 00 00 
    base.s.size = 0;
    3d74:	b8 44 5f 00 00       	mov    $0x5f44,%eax
    3d79:	c7 05 48 5f 00 00 00 	movl   $0x0,0x5f48
    3d80:	00 00 00 
