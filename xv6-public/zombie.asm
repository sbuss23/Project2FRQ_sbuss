...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 a7 02 00 00       	call   2bd <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 31 03 00 00       	call   355 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 99 02 00 00       	call   2c5 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 75 01 00 00       	call   2dd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1cd:	e8 33 01 00 00       	call   305 <open>
  if(fd < 0)
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 36 01 00 00       	call   31d <fstat>
  close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
  close(fd);
 1ec:	e8 fc 00 00 00       	call   2ed <close>
  return r;
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3f0:	e8 f0 fe ff ff       	call   2e5 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 460:	e8 80 fe ff ff       	call   2e5 <write>
 ...
 4c1:	e8 1f fe ff ff       	call   2e5 <write>
 ...
 4d8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4da:	e8 06 fe ff ff       	call   2e5 <write>
  for(i = 0; fmt[i]; i++){
 ...
 573:	57                   	push   %edi
 574:	53                   	push   %ebx
 575:	e8 6b fd ff ff       	call   2e5 <write>
        while(*s != 0){
 ...
 5c7:	e8 19 fd ff ff       	call   2e5 <write>
        ap++;
 ...
 5f1:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 84 0a 00 00       	mov    %eax,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 84 0a 00 00    	mov    0xa84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 84 0a 00 00    	cmp    %eax,0xa84
 6d7:	89 c2                	mov    %eax,%edx
 6d9:	75 ed                	jne    6c8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
 6db:	83 ec 0c             	sub    $0xc,%esp
 6de:	56                   	push   %esi
 6df:	e8 69 fc ff ff       	call   34d <sbrk>
  if(p == (char*)-1)
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 84 0a 00 00    	mov    %edx,0xa84
}
 ...
 747:	0a 00 00 
 74a:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 88 0a 00 00       	mov    $0xa88,%eax
 759:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 760:	00 00 00 
